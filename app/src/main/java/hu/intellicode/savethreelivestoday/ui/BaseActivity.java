    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_drawer_map: {
                // If there is only one blood donation point to show, it's data can be set in the starter intent.
                /*Intent i = MapActivity.getStarterIntent(this, DummyRepository.getADonationPoint());
                startActivity(i);*/
